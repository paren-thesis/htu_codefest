<?php
/**
 * HTU COMPSSA CODEFEST 2025 - Administrator Dashboard
...
<head>
    ...
    <title>Administrator Dashboard - <?php echo APP_NAME; ?></title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar">
                    <div class="p-3">
                        <h6 class="text-uppercase">Administrator Panel</h6>
                    </div>
            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content">
                    ...
                    <div class="welcome-section">
                        <h2><i class="fas fa-crown"></i> Welcome, Administrator!</h2>
                        <p class="mb-0">You have full access to manage the departmental dues system.</p>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <a href="../import_students.php" class="btn btn-primary w-100">
